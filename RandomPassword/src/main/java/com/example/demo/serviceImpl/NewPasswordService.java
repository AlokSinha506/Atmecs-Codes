...
@Service
public class NewPasswordService implements EmployeeService{
	...
	UserDetails userDetails;
	 ...
	 public  EmployeePasswordResponse buildSuccessResponse(HttpStatus statusCode, Object employee) {

		 EmployeePasswordResponse employeePasswordResponse = new EmployeePasswordResponse();
		 employeePasswordResponse.setResult(employee);
