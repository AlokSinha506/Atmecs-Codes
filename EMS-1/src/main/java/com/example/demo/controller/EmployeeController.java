...
public class EmployeeController {
		...
		@PatchMapping("/api/employees/{id}/managerId/{manager_id}")
		public ResponseEntity assignManager(@PathVariable("id") String employeeId,@PathVariable("manager_id") String managerId) {
			try {
